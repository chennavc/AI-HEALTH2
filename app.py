...
def cancer():
    if request.method == 'POST':
        ...
        return render_template('newcancer.html')
...
def kidney():
    if request.method == 'POST':
        ...
        print(prediction)
        output=prediction[0]
        return render_template('result.html',prediction_text="negetive ",output=output)
        # if output== 0:
        #     return render_template('result.html',prediction_text="negetive ",output=output)
        # else:
        #     return render_template('result.html',prediction_text="positive{}".format(output),output=output)
    else:
        return render_template('newkidney.html')
...
def heart():
    if request.method == 'POST':
        ...
        return render_template('newheart.html')
